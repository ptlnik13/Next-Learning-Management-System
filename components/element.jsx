        ...
        <div className='bg-darkBlue min-h-screen px-0 py-12'>
            <div className='w-full bg-fuchsia-50 p-6 flex flex-col md:flex-row items-center pt-5 pb-10 pl-10'>
                <div className='md:w-1/2 text-center md:text-left pt-10 pb-10'>
                    ...
                    <p className='text-gray-600'>Learn Programing skills, from absolute beginner to advanced mastery.We
                        try to create project base course which help your to learn professionally and make you fell as a
                        complete developer</p>
                </div>
