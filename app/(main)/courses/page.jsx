...
import ShortCourse from "@/app/(main)/courses/_components/ShortCourse";
...
const CoursesPage = async () => {
    ...
    return (
        ...
        >
            ...
            {/* header */}
            <div
                className="flex items-baseline justify-between  border-gray-200 border-b pb-6 flex-col gap-4 lg:flex-row">
                <SearchCourse/>
            ...
            <section className="pb-24 pt-6">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                    ...
                    {/* Course grid */}
                    <div
                        className="lg:col-span-3 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                        {courses.map((course) => {
                            return (
