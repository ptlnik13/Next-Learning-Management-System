                ...
                <div className="my-6">
                    <Tabs defaultValue="overview" className="w-full flex-col">
                        ...
                        <TabsContent value="curriculum">
                            {/* each tab content can be independent component */}
                            <div
                                className="flex gap-x-5 items-center justify-center flex-wrap mt-4 mb-6 text-gray-600 text-sm">
                            ...
                            >
                                <AccordionItem className="border-none" value="item-1">
                                    ...
                                    <AccordionContent>
                                        {/* header */}
                                        <div
                                            class="flex gap-x-5 items-center flex-wrap mt-4 mb-6 text-gray-600 text-sm">
                        <span className="flex items-center gap-1.5">
